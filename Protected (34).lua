local Success, Error = pcall(function()
    ...
    local FemWare                  = Framework:CreateWindow("DoomzWare 1.1.0", Vector2.new(492, 588))
    ...
    -- #region // Tabs
        ...
        -- #region // Credits Tab
            ...
            CreditsS:AddLabel("Doomz - Founder")
            CreditsS:AddLabel("DoomzWare - God Scripter")
            CreditsS:AddLabel("rub - trans")

            local ToggleToggleUI = InfoS:AddToggle("UI Shortcut", true, function(V)
                game:GetService("RunService").RenderStepped:Wait()
                game:GetService("CoreGui"):FindFirstChild("DoomzWare 1.1.0").Enabled = V
            end)
